...
Revision ID: 77d0318de506
Revises: 95981c7acbab
Create Date: 2022-06-09 14:38:33.203170
...
revision = '77d0318de506'
down_revision = '95981c7acbab'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('facebook_link', sa.VARCHAR(length=120), autoincrement=False, nullable=True),
    sa.Column('website_link', sa.VARCHAR(length=120), autoincrement=False, nullable=True),
    sa.Column('looking_for_talents', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.Column('seeking_description', sa.VARCHAR(length=120), autoincrement=False, nullable=True),
